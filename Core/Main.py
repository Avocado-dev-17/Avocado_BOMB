...
def main(page: Page):
    ...
    def color_change(e):
        ...
        global color
        color = choice(_color)
        banner.controls = [Text(spans=[TextSpan('Avocado BOMB', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('Avocado BOMB', TextStyle(size=95, color=color))], font_family='Consolas')]
    ...
    # Баннер
    banner = Stack([Text(spans=[TextSpan('Avocado BOMB', TextStyle(size=95, foreground=Paint(color=color, stroke_width=9, stroke_join='round', style='stroke')))], font_family='Consolas'), Text(spans=[TextSpan('Avocado BOMB', TextStyle(size=95, color=color))], font_family='Consolas')])
    ...
    def ADD():
        ...
        page.add(
                ...
                Row([IconButton(icon='color_lens_sharp', icon_size=48, tooltip='Цвет (рандом)', icon_color=color, on_click=color_change),
                    IconButton(icon='mode_night', icon_size=48, tooltip='Тема', on_click=theme_change, icon_color=color),
